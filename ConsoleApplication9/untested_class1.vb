Public Class function_OP
    ...
    Public Shared Function integrate(ByVal g As f, a As Decimal, b As Decimal, n As Integer, Optional m As Integer = 3) As Decimal
        ...
        For i = 0 To n - 1
            For j = 0 To m
                c += (h / 2) * intgrl2(AddressOf lag, h2, i) * g((h / 2) * (j*h2-1) + (2*a+h*(2*i+1) / 2))
            Next
        Next
        'Return function_OP.rnd(c, 7)
        Return c
    End Function
    Public Shared Function lag(x As Decimal, h2 As Decimal, n As Integer) As Decimal
        Dim c As Decimal = 1
        ...
        Return c
    End Function
    Public Shared Function intgrl2(ByVal g As f2, h2 As Decimal, n As Integer, Optional j As Integer = 3) As Decimal
        Dim c As Decimal
        Dim x(0) As Double
